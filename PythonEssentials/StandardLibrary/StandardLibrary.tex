...
To delete a variable from the namespace, use the \li{del} keyword (\textbf{with caution!}).
...
Importing the file also executes each line,\footnote{Try importing the \li{this} or \li{antigravity} modules.
