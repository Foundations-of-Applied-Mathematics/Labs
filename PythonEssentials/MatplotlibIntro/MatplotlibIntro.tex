...
Use \li{plt.pcolormesh()} to create a heat map. It is required to include an argument for the shading type; this determines the layout and fill style of the heat map. Setting \li{shading='auto'} will automatically choose a fill method suited to the data being graphed.
