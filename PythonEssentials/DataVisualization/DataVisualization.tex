...
\footnote{You can also create an ordered scatter plot with \li{plt.plot()} by specifying a point marker such as \li{'.'}, \li{','}, \li{'o'}, or \li{'+'}.
The keywords \li{s} and \li{c} can be used to change the marker size and marker color, respectively.}
