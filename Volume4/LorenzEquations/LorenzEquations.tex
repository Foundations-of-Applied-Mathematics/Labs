...
\begin{warn}
The above animation code works great for 2D animations, but \li{set_data()} is only good for 2D. When you want to animate in 3D, you will need the extra \li{set_3d_properties()} call in your \li{update(index)} function.
\end{warn}

\section*{Animate the Beast}
