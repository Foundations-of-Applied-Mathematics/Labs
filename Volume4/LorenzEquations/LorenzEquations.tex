...
Hint: to ensure that the two numerical solutions have the same timesteps, you can use the \li{t_eval} argument of \li{solve_ivp}.
Using this argument causes \li{solve_ivp} to return the solution's values at the points you pass in.
\end{problem}
