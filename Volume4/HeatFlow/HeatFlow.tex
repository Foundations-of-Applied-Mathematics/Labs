...
\begin{align}
	...
	\end{split}
\end{align}
Note that this is an implicit linear scheme; hence, the most efficient way to find \(U^{j+1}\) is to create the matrix \(B\) as a sparse matrix and use \li{scipy.sparse.linalg.spsolve}.
