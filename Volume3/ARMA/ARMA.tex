...
Use your function to predict the next \li{n} values of the time series found in \li{weather.npy}.
...
Predict the next \li{n} observations by iterating through Equation \ref{eq:arima:def}.
