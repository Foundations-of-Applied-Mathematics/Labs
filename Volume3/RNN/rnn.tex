...
\item Randomly split the data into training, validation, and test sets using a $70/15/15$ split (use \li{torch.utils.data.random(data,lengths)} where \li{lengths=[0.7, 0.15, 0.15]}).
