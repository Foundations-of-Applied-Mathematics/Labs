...
\begin{problem}
Use Equations \eqref{eqn:kalman_algorithm} to add a method to your \li{KalmanFilter} class that estimates a state sequence corresponding to a given observation sequence and initial state estimate.
