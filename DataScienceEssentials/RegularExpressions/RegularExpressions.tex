...
As we have seen thus far, regular expressions are very useful when we want to match patterns.
...
Recall that \li{grep} is used to match patterns in files or output.
