...
Then, create a new GeoDataFrame using a dictionary with key \li{'geometry'} and with a list of these three Polygons as the value.
...
Include a colorbar using the arguments \li{legend=True} and \li{cmap='PuBu_r'} in the \li{plot} function.
