...
Once opening a new Colab Notebook, upload the file \li{pandas4.ipynb}.
...
For this lab, upload \li{DJIA.csv}, \li{paychecks.csv}, \li{finances.csv}, and \li{website_traffic.csv}.
...
Push the newly made \li{pandas4.py} file.
\end{info}
...
(Hint: Call \li{prob1()} to get the DataFrame already cleaned and with DatetimeIndex).
\end{problem}
