...
\begin{enumerate}
\item What was the highest paid race/sex combination?
\item What race/sex combination worked the least amount of hours?
\item What race/sex combination worked the most hours per week per person?
\end{enumerate}
...
\item Partition the \li{Age} column into 4 equally populated intervals. 
What is the most common age range among workers?
...
\begin{problem}
Examine the college dataset using pivot tables and groupby objects.
...
\item Partition \li{Grad.Rate} into intervals of 20\%.
Is the partition with the greatest number of schools the same for private and public universities?

\item Divide the acceptance rate into partitions of 25\%.
Does having a lower acceptance rate correlate with having more students from the top 10 percent of their high school class being admitted on average for BOTH private and public universities?

\item Why is the average percentage of students admitted from the top 10 percent of their high school class so high in private universities with very low acceptance rates?
\end{enumerate}
\end{problem}
\begin{comment}
