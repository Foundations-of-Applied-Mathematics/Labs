...
\begin{problem}
The data \li{time_usage.txt} contains data on how Americans spend their time from 2007-2017.
Read in the data as a \li{DataFrame} object and use \li{groupby()} to filter through the \li{DataFrame} and answer the following questions:
...
(Hint: The column \li{Estimate} gives the amount of hours spent on an activity. The activity \li{Watching TV} contains data on Americans watching TV and the activity \li{Participating in Sports Exercise and Rec Activity} contains data on Americans exercising.)
\end{problem}
...
\begin{problem}
The file \li{Ohio_1999.csv} contains data on workers in Ohio in the year 1999. Use pivot tables to answer the following questions:
...
\begin{problem}
The \li{pydataset} contains a data set \li{iris}, which contains the measurements of various flower species.
