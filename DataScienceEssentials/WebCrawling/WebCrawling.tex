...
In this example, the \li{for} loop cycles through the pages of books, and the \li{while} loop ensures that each website page loads properly: if the downloaded \li{page_source} doesn't have a tag whose class is ``product\_prod'', the request is sent again.
