...
\labdependencies{ObjectOriented}
...
\\
\begin{warn}
This lab is a continuation of The Discrete Fourier Transform lab and will expand the \li{SoundWave} class that was implemented there.
Before beginning this lab, make sure to copy your code for the methods \li{__init__()}, \li{plot()}, \li{export()}, \li{__add__()}, and \li{__rshift__()} into the \li{SoundWave} class in the new Jupyter Notebook.
\end{warn}
...
\begin{subfigure}{.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/blurry_face.pdf}
    \caption{The original blurry image.}
    \label{fig:blurry_face}
\end{subfigure}
\begin{subfigure}{.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/blurry_dft.pdf}
    \caption{The DFT of the original image.}
    \label{fig:blurry_fft}
\end{subfigure}
\begin{subfigure}{.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/cleaned_face.pdf}
    \caption{The improved image.}
    \label{fig:improved_face}
\end{subfigure}
\begin{subfigure}{.4\textwidth}
    \centering
    \includegraphics[width=\linewidth]{figures/cleaned_dft.pdf}
...
B_{ij} = \left\{
   ...
   \right.
\]
Here, $\nabla A(ij) = ((A \ast S)_{ij}, (A\ast S\trp )_{ij})$ is the gradient of $A$ at the $ij$th pixel.
