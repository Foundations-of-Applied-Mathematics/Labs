...
\labdependencies{OneDOptimization}
...
There is a file called \li{test_gradient_methods.py} that contains some prewritten unit tests that you can use to test your function.
...
\begin{unittest}
There is a file called \li{test_gradient_methods.py} that contains some prewritten unit tests for Problem 2.
