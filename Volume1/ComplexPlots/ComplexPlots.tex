...
\begin{figure}
\includegraphics[width=.7\textwidth]{figures/Identity.png}
...
\begin{figure}[H]
\includegraphics[width=.6\textwidth]{figures/check_plot.png}
...
\begin{figure}[H]
\includegraphics[width=\textwidth]{figures/check_plot_magnitude.png}
...
\begin{figure}
\includegraphics[width=.6\textwidth]{figures/zeros.png}
...
\begin{figure}
\includegraphics[width=.6\textwidth]{figures/essential_pole.png}
...
\end{subfigure}
\begin{subfigure}{.49\textwidth}
\includegraphics[width=\textwidth]{figures/function2.png}
\end{subfigure}
...
\begin{figure}
\includegraphics[width=\textwidth]{figures/function1.png}
...
\begin{figure}
\begin{subfigure}{.49\textwidth}
\includegraphics[width=\textwidth]{figures/possqrt.png}
\end{subfigure}
\begin{subfigure}{.49\textwidth}
\includegraphics[width=\textwidth]{figures/negsqrt.png}
\end{subfigure}
