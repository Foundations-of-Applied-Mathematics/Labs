...
Return the values of the speed $\sqrt{x'(t)^2+y'(t)^2}$ at each $t$ as a \li{np.array}.
...
pip install "jax[cpu]"
\end{lstlisting}
Installation directly via \li{pip} is currently only supported on Windows \emph{experimentally}.
